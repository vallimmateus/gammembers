	...
	var list2 = [
		{
			...
			total: 9,
			pessoas: {
				"Moto Moto": ["Realizações"],
				Mari: ["Realizações, Projeto Project Lab, Diretoria"],
				Álvaro: ["Realizações"],
				Ciampi: ["Realizações, Liderança, Diretoria"],
				Suzi: ["Realizações, Liderança"],
				Leandro: ["Realizações, Núcleo de App"],
				Dan: ["Realizações"],
				Bangu: ["Realizações, Núcleo de App, Diretoria"],
				Ge: ["Realizações, Núcleo de App"],
			},
		},
		{
			respondidos: 0,
			pessoas: {
				Maré: ["Projeto Lojas JB"],
		...
		},
		{
			...
			respondidos: 0,
			pessoas: {
				Samu: ["Liderança, Projeto Project Lab, Diretoria"],
				Mari: ["Realizações, Projeto Project Lab, Diretoria"],
			},
		},
		{
